...
export const addUser = (token, user, file) => addData(token, user, file, `${ADMIN_USERS_API}/add`, "photo_URL");
export const deleteUser = (token, id) => deleteData(token, id, `${ADMIN_USERS_API}/markDeleted`);
export const updateUser = (token, user, file) => updateData(token, user, file, `${ADMIN_USERS_API}/updateAdmin`, "photo_URL");
